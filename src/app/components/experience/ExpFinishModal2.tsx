  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
      ...
      <div className="w-[500px] h-[650px] relative bg-slate-200 rounded-[10px]">
        <div className="left-[30px] top-[145px] absolute text-black text-lg font-semibold leading-[27px]">
        나의 활동 & 경험 내용{' '}
        </div>
        <div className="w-[439px] h-[140px] left-[30px] top-[178px] absolute bg-slate-100 rounded-[10px]" />
        <div className="w-[415px] h-[120px] left-[40px] top-[189px] absolute text-black text-base font-medium leading-normal">
        {experienceData.detail}
        </div>
        ...
        <div className="left-[30px] top-[370px] absolute text-black text-lg font-semibold leading-[27px]">
        결과 및 성과
        </div>
        <div className="w-[439px] h-[140px] left-[30px] top-[404px] absolute bg-slate-100 rounded-[10px]" />
        <div className="w-[415px] h-[120px] left-[40px] top-[415px] absolute text-black text-base font-medium leading-normal">
        {experienceData.advance}
        </div>
        <div className="w-[95px] h-4 left-[390px] top-[20px] absolute justify-start items-start gap-[4px] inline-flex">
          <div className="w-[80px] h-4 relative">
            <div className="w-[14px] h-[14px] left-[16px] top-0 absolute bg-blue-400 rounded-[50px]" />
            <div className="w-[28px] h-[14px] left-[36px] top-0 absolute bg-blue-600 rounded-full" />
            <div className="w-[14px] h-[14px] left-[70px] top-0 absolute bg-blue-400 rounded-full" />
          </div>
        </div>
      </div>
      <div className="w-[640px] h-[52px] left-[430px] top-[340px] absolute justify-start items-start gap-[580px] inline-flex">
