      ...
      >
        ...
        <div className="w-[95px] h-4 left-[390px] top-[20px] absolute justify-start items-start gap-[4px] inline-flex">
          <div className="w-[80px] h-4 relative">
            ...
            <div className="w-[14px] h-[14px] left-[36px] top-0 absolute bg-[#7AAAE8] rounded-full" />
            <div className="w-[28px] h-[14px] left-[56px] top-0 absolute bg-[#0A7AFF] rounded-[50px]" />
          </div>
        </div>
        <div
...
export default UserExpDetailModal3
